...
describe('Feature Banner Page', () => {
  it('should navigate and interact with the Feature Banner Page', () => {
    ...
    // Click on Feature Banner
    cy.xpath('//a[@href="/featurebanners"]').click({force:true});
    cy.wait(3000);

...
describe('Insta360 Page Automation', () => {
    ...
    it('should perform actions on the Insta360 page', () => {
      ...
      // Click on the exterior360 menu
      cy.xpath('//*[@id="root"]/div[1]/aside/div[2]/div/div[2]/ul/li[16]/a/i').click();
      ...
      cy.xpath('//*[@id="root"]/div[1]/div/div/div[2]/div[3]/div/div[1]/div[1]/table/tbody/tr/td[2]/div[1]')
        .trigger('dblclick');
      cy.wait(3000);
  
      // Double click on the next data column
      cy.xpath('//*[@id="root"]/div[1]/div/div/div[2]/div[3]/div/div[1]/div[2]/div/table/tbody/tr/td[2]/div[1]')
        .trigger('dblclick');
      cy.wait(3000);
  
      // Double click on the subtosub folder
      cy.xpath('//*[@id="root"]/div[1]/div/div/div[2]/div[3]/div/div[1]/div[2]/div[2]/div/table/tbody/tr/td[2]/div[1]')
        .trigger('dblclick');
      cy.wait(3000);

     cy.get('#leaf11926', { timeout: 10000 })
    .should('be.visible')
     .then($video => {
    $video[0].muted = true
    $video[0].play()
